...
(function (l09_2) {
    class Flower {
        ...
        draw() {
            ...
            l09_2.context.fillRect(this.position[0] - this.dimensions[0] / 2, this.position[1], this.dimensions[0], -this.dimensions[1]);
            l09_2.context.beginPath();
            l09_2.context.moveTo(this.innerPoints[0][0], this.innerPoints[0][1]);
            for (let i = 0; i < this.innerPoints.length; i++) {
                l09_2.context.bezierCurveTo(this.outerPoints[i][0], this.outerPoints[i][1], this.outerPoints[(i + 1) % this.innerPoints.length][0], this.outerPoints[(i + 1) % this.innerPoints.length][1], this.innerPoints[(i + 1) % this.innerPoints.length][0], this.innerPoints[(i + 1) % this.innerPoints.length][1]);
            }
            l09_2.context.closePath();
            l09_2.context.fillStyle = this.color;
            l09_2.context.fill();
            l09_2.context.strokeStyle = "black";
